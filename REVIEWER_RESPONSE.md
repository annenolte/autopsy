...
| 9 | Is benchmark code actually AI-generated? Authorship detector never validated | 🟡 Partial | FP-on-human side now measured (#8). **Still:** a labeled AI-vs-human commit set for precision/recall/AUC, and report vuln-detection separately from authorship prioritization. Couldn't fabricate the AI-positive set. |
