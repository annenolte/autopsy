...
| 9 | Is benchmark code actually AI-generated? Authorship detector never validated | ✅ Done (artifact) | Validated as a classifier on the **SecurityEval** labeled set (260 Copilot/InCoder AI files vs 121 human files): **ROC-AUC 0.42 (≈ random), recall 0% @0.5** — the heuristic does **not** distinguish AI from human code. Honest negative result (`benchmark/eval_authorship_classifier.py`, AUTHORSHIP.md). **Paper action: descope the authorship detector; report vuln-detection separately.** |
